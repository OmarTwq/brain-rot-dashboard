...
# =========================================================
# العنوان + نظرة المستشار التنفيذي
# =========================================================
st.title("🧠 Student Social Media & Mental Health — Brain Rot Dashboard")
st.caption("منظور تحليلي بصفة مستشار بيانات وذكاء اصطناعي — تحليل تفاعلي لأثر استخدام السوشل ميديا على الصحة النفسية للطلاب")
...
tab1, tab2, tab3, tab4, tab5 = st.tabs([
    ...
    "🌲 تصنيف مستوى التوتر", "📝 ملخص المستشار"
])
...
# ---------------------------------------------------------
with tab5:
    st.subheader("📝 ملخص تنفيذي — منظور مستشار بيانات")
